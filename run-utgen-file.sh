...
do
  ...
  java -jar utgen-r.jar -projectCP "$sourceDir/$CP" -class $class -Dcriterion=BRANCH:LINE:OUTPUT:METHOD:CBRANCH \
   ...
   -Dllm_test_generation_approach=FILE -Dllm_test_file_source_directory=utgen-file-tests/llm-tests/$llm_test \
