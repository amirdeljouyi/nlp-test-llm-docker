...
do
  ...
  java --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/sun.util.calendar=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED \
    -jar utgen-r.jar -projectCP "$sourceDir/$CP" -class $class -Dcriterion=BRANCH:LINE:OUTPUT:METHOD:CBRANCH \
   ...
   -Dllm_test_generation_approach=FILES -Dllm_test_file_source_directory=utgen-files-tests/llm-tests/$llm_test -Dtimeline_interval=5000 \
