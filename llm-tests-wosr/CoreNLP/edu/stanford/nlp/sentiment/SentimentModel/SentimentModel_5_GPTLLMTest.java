...
@Test
  public void testParamsVectorLosslessConversion() {
    ...
    SentimentModel duplicate = SentimentModel.modelFromMatrices(W.copy(), Wcat.copy(), Wt.copy(), new HashMap<>(wordVectors), options);
...
@Test(expected = AssertionError.class)
  public void testGetClassWForNode_threeChildren_throws() {
    ...
    Tree tree = new LabeledScoredTreeFactory().newTreeNode("Root", Arrays.asList(leaf1, leaf2, leaf3));
...
@Test
  public void testGetClassWForNode_UnaryClassificationPath() {
    ...
    Tree node = new LabeledScoredTreeFactory().newTreeNode("Preterminal", Collections.singletonList(leaf));
...
@Test
  public void testGetBinaryTensor_withExactKeyMatching() {
    ...
    options.langpack = new edu.stanford.nlp.parser.lexparser.EnglishTreebankParserParams().treebankLanguagePack();
    ...
    SentimentModel model = new SentimentModel(emptyMatrixMap, tensors, emptyMatrixMap, emptyUnary, wordVectors, options);
...
@Test
  public void testToString_outputsEachSectionIndividually() {
    ...
    SentimentModel model = new SentimentModel(binaryTransform, binaryTensors, TwoDimensionalMap.treeMap(), unary, wordVectors, options);
...
@Test
  public void testGetBinaryClassification_returnsNullWhenNotPresentAndNotCombined() {
    ...
    SentimentModel model = new SentimentModel(TwoDimensionalMap.treeMap(), TwoDimensionalMap.treeMap(),
            binaryClassification, new HashMap<>(), wordVectors, options);
...
@Test
  public void testGetBinaryTransform_returnsNullWhenNotPresent() {
    ...
    SentimentModel model = new SentimentModel(
            ...
            TwoDimensionalMap.treeMap(), new HashMap<>(), wordVectors, options);
...
@Test
  public void testPrintParamInformation_onWordVectorIndex() {
    ...
    SentimentModel model = new SentimentModel(
            TwoDimensionalMap.treeMap(), TwoDimensionalMap.treeMap(),
            TwoDimensionalMap.treeMap(), unary, wordVectors, options);
...
@Test
  public void testParamsToVectorIncludesAllComponents() {
    ...
    SentimentModel model = new SentimentModel(binaryTransform, binaryTensors,
            TwoDimensionalMap.treeMap(), unaryClass, wordVectors, options);
...
@Test
  public void testGetWForNode_returnsNullIfMatrixMissing() {
    ...
    SentimentModel model = new SentimentModel(TwoDimensionalMap.treeMap(),
            TwoDimensionalMap.treeMap(), TwoDimensionalMap.treeMap(),
...
@Test(expected = RuntimeException.class)
  public void testInitRandomWordVectors_missingNumHidThrows() {
    ...
    List<Tree> trees = new ArrayList<>();
    Tree t = new LabeledScoredTreeFactory().newTreeNode("X", Arrays.asList(
...
@Test
  public void testToString_withMixedComponents() {
    ...
    SentimentModel model = new SentimentModel(binaryTransform, binaryTensors,
      TwoDimensionalMap.treeMap(), unaryClassification, wordVectors, options);
...
@Test
  public void testGetClassWForNode_withUnaryKeyNotPresent_returnsNull() {
    ...
    SentimentModel model = new SentimentModel(
      TwoDimensionalMap.treeMap(), TwoDimensionalMap.treeMap(),
      TwoDimensionalMap.treeMap(), unaryClass,
      wordVectors, options);
