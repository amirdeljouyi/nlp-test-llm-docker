...
@Test(expected = AssertionError.class)
  public void testGetWForNodeWithUnaryChildThrows() {
    ...
    SentimentModel model = new SentimentModel(options, Collections.singletonList(Tree.valueOf("Leaf")));
...
@Test(expected = AssertionError.class)
  public void testGetTensorForUnaryNodeThrows() {
    ...
    Tree unary = new LabeledScoredTreeFactory().newTreeNode("LABEL", Collections.singletonList(leaf));
...
@Test
  public void testGetClassWForNodeUnarySimplifiedCombineFalse() {
    ...
    Tree unary = new LabeledScoredTreeFactory().newTreeNode("TAG", Collections.singletonList(terminal));
...
@Test(expected = RuntimeException.class)
  public void testSaveSerializedThrowsIfPathIsInvalid() {
    ...
    String invalidFilePath = File.separator + "this" + File.separator + "should" + File.separator + "fail" + File.separator + "sent.model";
...
@Test(expected = AssertionError.class)
  public void testGetClassWForNodeWithEmptyChildrenThrowsAssertionError() {
    ...
    SentimentModel model = new SentimentModel(options, Collections.singletonList(Tree.valueOf("x")));
...
@Test
  public void testOverriddenToStringIncludesMatrixData() {
    ...
    assertTrue(out.contains("Binary transform matrix") || out.contains("Binary transform matrices"));
...
@Test
  public void testGetUnaryClassificationReturnsNullIfNotMatchEvenAfterBasicCategorySimplifiedFalse() {
    RNNOptions options = new RNNOptions();
    options.combineClassification = true;
    options.simplifiedModel = false;
    options.numHid = 2;
