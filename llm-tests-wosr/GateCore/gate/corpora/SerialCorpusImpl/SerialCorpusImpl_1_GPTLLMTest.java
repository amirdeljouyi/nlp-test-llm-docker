...
@Test
  public void testAddCorpusListenerTwiceDoesNotDuplicate() throws Exception {
    ...
    CorpusListener listener = new CorpusListener() {
      public void documentAdded(CorpusEvent e) { calls.add("added"); }
      public void documentRemoved(CorpusEvent e) { calls.add("removed"); }
    };
...
@Test(expected = GateRuntimeException.class)
  public void testUnloadFailsOnSyncError() throws Exception {
    ...
    Document broken = new Document() {
      public Object getLRPersistenceId() { return null; }
      public String getName() { return "ErrorDoc"; }
      ...
      public Resource init() throws ResourceInstantiationException { return null; }
      public void sync() {}
      public void delete() {}
...
@Test
  public void testDocumentIdentityDoesNotMatchDueToClassMismatch() throws Exception {
    ...
    Document doc2 = new DocumentImpl() {
      ...
      public Object getLRPersistenceId() { return "doc-id"; }
    };
