...
public void testDuplicateFeatureInFeatureVector() {
    ...
    FeatureVector fv = new FeatureVector(dataAlphabet,
            new int[]{featureIndex, featureIndex},
            new double[]{1.0, 2.0});

    Labeling labeling = new LabelVector(targetAlphabet,
            new int[]{targetAlphabet.lookupIndex("dupclass")}, new double[]{1.0});
    Instance instance = new Instance(fv, labeling, null, null);
...
public void testTrainSingleInstanceWithDocNormalizationZeroNorm() {
    ...
    FeatureVector fv = new FeatureVector(dataAlphabet, new int[]{}, new double[]{});
    Labeling labeling = new LabelVector(targetAlphabet,
            new int[]{targetAlphabet.lookupIndex("foo")}, new double[]{1.0});
    Instance instance = new Instance(fv, labeling, null, null);
...
public void testSetDocLengthNormalizationPositiveValueAffectsTraining() {
    ...
    FeatureVector fv = new FeatureVector(dataAlphabet,
            new int[]{dataAlphabet.lookupIndex("word1"), dataAlphabet.lookupIndex("word2")},
            new double[]{1.0, 1.0});

    Labeling labeling = new LabelVector(targetAlphabet,
            new int[]{targetAlphabet.lookupIndex("label")}, new double[]{1.0});
