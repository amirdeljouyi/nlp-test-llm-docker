...
@Test
    public void testFactoryCreatesTrainerWithCorrectSettings() {
        ...
        NaiveBayesTrainer.Factory factory = new NaiveBayesTrainer.Factory()
                .setFeatureMultinomialEstimator(featureEstimator)
                .setPriorMultinomialEstimator(priorEstimator)
                .setDocLengthNormalization(42.0);
...
@Test
    public void testTrainWithInstanceHavingMultipleZeroWeightLabelsSkipsIncorporation() {
        ...
        LabelVector labeling = new LabelVector(targetAlphabet,
                new int[]{l1.getIndex(), l2.getIndex()}, new double[]{0.0, 0.0});
...
@Test
    public void testFactorySetsAllParametersCorrectly() {
        ...
        NaiveBayesTrainer.Factory factory = new NaiveBayesTrainer.Factory()
                .setFeatureMultinomialEstimator(customFeatureEstimator)
                .setPriorMultinomialEstimator(customPriorEstimator)
                .setDocLengthNormalization(5.0);
...
@Test
    public void testFactoryCreatesNewTrainerFromClassifier() {
        ...
        assertEquals(initialTrainer.getClassifier().getLabelAlphabet().size(),
                     newTrainer.getClassifier().getLabelAlphabet().size());
    }
@Test
...
@Test
    public void testEstimateFeatureMultinomialsHandlesEmptyTargetAlphabet() {
        ...
        trainer.trainIncremental(new Instance(
                new FeatureVector(dataAlphabet, new int[]{}, new double[]{}),
                null,
                "empty",
                null));
