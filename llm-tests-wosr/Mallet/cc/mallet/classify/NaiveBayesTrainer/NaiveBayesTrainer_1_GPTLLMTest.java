...
@Test
    public void testSerializationIntegrity() throws IOException, ClassNotFoundException {
        ...
        assertEquals(trainer.getClassifier().getLabelAlphabet().size(),
                     deserialized.getClassifier().getLabelAlphabet().size());
    }
@Test
...
@Test(expected = IllegalArgumentException.class)
    public void testTrainingSetWithNullAlphabetThrowsException() {
        ...
        Pipe forcedPipe = new Pipe() {
            ...
            public Alphabet getDataAlphabet() { return dataAlphabet; }

            public Alphabet getTargetAlphabet() { return null; }
        };
