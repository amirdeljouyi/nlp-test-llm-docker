...
@Test
    public void testGradientZeroForUnusedFeaturesWhenFeatureSelectionSet() {
        ...
        MaxEnt classifier = new MaxEnt(pipe, new double[2 * (dataAlphabet.size() + 1)],
                list.getFeatureSelection(), null);
...
@Test
    public void testSetParametersWithIncorrectLengthShorter() {
        ...
        Pipe pipe = new Pipe() { public Instance pipe(Instance carrier) { return carrier; } };
