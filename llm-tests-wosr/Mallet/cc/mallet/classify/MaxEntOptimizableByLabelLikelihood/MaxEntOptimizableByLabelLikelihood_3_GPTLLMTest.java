...
@Test
    public void testGetNumParameters() {
        Pipe pipe = new SerialPipes(Arrays.asList(
            new Input2CharSequence("UTF-8"),
            new CharSequenceLowercase(),
            new CharSequence2TokenSequence("[\\p{L}\\p{N}_]+"),
            new TokenSequenceRemoveStopwords(false, false),
            new TokenSequence2FeatureVector(),
            new Target2Label()
        ));
        InstanceList trainingSet = new InstanceList(pipe);
...
@Test
    public void testSetAndGetParametersArray() {
        Pipe pipe = new SerialPipes(Arrays.asList(
            new Input2CharSequence("UTF-8"),
            new CharSequence2TokenSequence("[a-zA-Z]+"),
            new TokenSequence2FeatureVector(),
            new Target2Label()
        ));
        InstanceList list = new InstanceList(pipe);
...
public void testCallingGetValueGradientTwiceIncrementsOnlyOnceIfCached() {
    Pipe pipe = new SerialPipes(Arrays.asList(
        new Input2CharSequence("UTF-8"),
        new CharSequence2TokenSequence("[a-z]+"),
        new TokenSequence2FeatureVector(),
        new Target2Label()
    ));
    InstanceList dataset = new InstanceList(pipe);
