...
@Test
    public void testAddInstancesAndInitialTopicAssignment() throws Exception {
        ...
        Pipe pipe = new SerialPipes(Arrays.asList(new Pipe[] {
...
@Test
    public void testAddInstancesWithEmptyInstanceList() {
        InstanceList empty = new InstanceList(new SerialPipes(Arrays.asList(new Pipe[] {
            new TokenSequence2FeatureSequence(new Alphabet())
        })));
...
@Test
    public void testTemperingWithEmptyAlphaStats() {
        ...
        callables[0] = new WorkerCallable(2, model.alpha, model.alphaSum, model.beta,
                                          new Randoms(), model.getData(),
                                          model.getTypeTopicCounts(), model.getTokensPerTopic(), 0, 1);
...
@Test
    public void testSingleTopicModelProducesUniformDistribution() {
        Alphabet alphabet = new Alphabet();
        SerialPipes pipes = new SerialPipes(Arrays.asList(new Pipe[]{
                new TokenSequence2FeatureSequence(alphabet)
        }));
...
@Test
    public void testOptimizeBetaWithUniformTokensPerTopicDoesNotThrow() {
        ...
        WorkerCallable[] callables = new WorkerCallable[1];
        callables[0] = new WorkerCallable(model.getNumTopics(), model.alpha, model.alphaSum, model.beta,
                                          new Randoms(), model.getData(),
                                          model.getTypeTopicCounts(), model.getTokensPerTopic(), 0, 1);
...
@Test
    public void testTemperAlphaWithInitializedCallableArrays() {
        ...
        callables[0] = new WorkerCallable(2, model.alpha, model.alphaSum, model.beta, new Randoms(),
                                          new ArrayList<>(), new int[0][], new int[0], 0, 0);
