...
@Test
    public void testExceptionDuringOptimizeAlphaHandledGracefully() {
        ...
        callables[0] = new WorkerCallable(3, model.alpha, model.alphaSum, model.beta,
                new Randoms(), new ArrayList<TopicAssignment>(), new int[0][0], new int[3], 0, 0);
...
@Test
    public void testLearnSymmetricConcentrationSingleThreadBehavior() {
        ...
        WorkerCallable[] callables = new WorkerCallable[1];
        callables[0] = new WorkerCallable(4, model.alpha, model.alphaSum, model.beta,
                new Randoms(), new ArrayList<TopicAssignment>(), new int[0][0], new int[4], 0, 0);
        callables[0].initializeAlphaStatistics(3);
