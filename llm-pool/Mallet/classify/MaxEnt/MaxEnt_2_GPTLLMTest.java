...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "x y z", "a b c" }, new String[] { "Y", "X" }));
// Alphabet dataAlphabet = pipe.getDataAlphabet();
LabelAlphabet labelAlphabet = (LabelAlphabet) pipe.getTargetAlphabet();
int numParams = MaxEnt.getNumParameters(pipe);
double[] parameters = new double[numParams];
...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "a b", "c d" }, new String[] { "pos", "neg" }));
...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "foo bar", "bar baz" }, new String[] { "A", "B" }));
// int numParams = MaxEnt.getNumParameters(pipe);
// double[] parameters = new double[numParams];
// parameters[0] = 0.1;
// parameters[1] = 0.2;
...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "one word" }, new String[] { "Label" }));
// int numParams = MaxEnt.getNumParameters(pipe);
// double[] parameters = new double[numParams];
// parameters[0] = 0.1;
// MaxEnt classifier = new MaxEnt(pipe, parameters);
...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "word1 word2" }, new String[] { "ClassA" }));
// int numParams = MaxEnt.getNumParameters(pipe);
// double[] parameters = new double[numParams];
// parameters[0] = 0;
// MaxEnt classifier = new MaxEnt(pipe, parameters);
...
pipe.setTargetProcessing(true);
InstanceList instances = new InstanceList(pipe);
// instances.addThruPipe(new StringArrayIterator(new String[] { "x y", "z q" }, new String[] { "A", "B" }));
// int numParams = MaxEnt.getNumParameters(pipe);
// double[] parameters = new double[numParams];
...
pipe.setTargetProcessing(true);
InstanceList list = new InstanceList(pipe);
// list.addThruPipe(new StringArrayIterator(new String[] { "hello world" }, new String[] { "CATEGORY" }));
// int numParams = MaxEnt.getNumParameters(pipe);
// double[] parameters = new double[numParams];
...
pipe.setTargetProcessing(true);
InstanceList list = new InstanceList(pipe);
// list.addThruPipe(new StringArrayIterator(new String[] { "sample input" }, new String[] { "label1" }));
...
pipe.setTargetProcessing(true);
InstanceList list = new InstanceList(pipe);
// list.addThruPipe(new StringArrayIterator(new String[] { "a b" }, new String[] { "X" }));
