...
outputDir="/app/dataset/llmsuite-wosr"
...

{
  ...
  do
    ...
    java -jar llmsuite-8.jar -projectCP "$newCP" -class $class -Dcriterion=BRANCH:LINE:OUTPUT:METHOD:CBRANCH \
     ...
     -Dllm_test_generation_approach=FILES -Dllm_test_file_source_directory=llm-tests-wosr/$llm_test -Dtimeline_interval=5000 \
