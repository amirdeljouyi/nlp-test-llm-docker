...
outputDir="/app/dataset/llminputonly"
...

{
  ...
  do
    ...
    java --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/sun.util.calendar=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED \
      ...
      -Dalgorithm=DYNAMOSA -Dllm_stabled_budget=30 $dattempt \
      ...
      -Dllm_static_constant_pool_approach=FILE -Dllm_test_pool_file_directory=llm-pool/$llm_test -Dtimeline_interval=5000 \
      -Ddefuse_debug_mode=true -Dtest_format=JUNIT4 -Djunit_check_timeout=10000 \
      -Dcheck_contracts=false -Dllm_static_constant_pool=true -Dsandbox=false -Dno_runtime_dependency=false -Dreset_static_fields=false \
