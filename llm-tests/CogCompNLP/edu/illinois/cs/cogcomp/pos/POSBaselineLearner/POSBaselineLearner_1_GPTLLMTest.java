...
// }
// };
Word word1 = new Word("tieWord");
// word1.tag = "NN";
Word word2 = new Word("tieWord");
// word2.tag = "VB";
learner.learn(word1);
learner.learn(word2);
...
// }
// };
Word w1 = new Word("walk");
// w1.tag = "VB";
Word w2 = new Word("walk");
// w2.tag = "VB";
Word w3 = new Word("walk");
// w3.tag = "NN";
Word w4 = new Word("walk");
// w4.tag = "TO";
learner.learn(w1);
learner.learn(w2);
learner.learn(w3);
...
// }
// };
Word w1 = new Word("balanced");
// w1.tag = "A";
Word w2 = new Word("balanced");
// w2.tag = "B";
learner.learn(w1);
learner.learn(w2);
...
// 
// public String discreteValue(Object o) {
// if (((Word) o).tag.equals("VBP"))
// return "VBP";
// if (((Word) o).tag.equals("NN"))
// return "NN";
// return "OTHER";
// }
// };
Word w1 = new Word("eat");
// w1.tag = "VBP";
Word w2 = new Word("eat");
// w2.tag = "NN";
Word w3 = new Word("eat");
// w3.tag = "NN";
learner.learn(w1);
learner.learn(w2);
learner.learn(w3);
