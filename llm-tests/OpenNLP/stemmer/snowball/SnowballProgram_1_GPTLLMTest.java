...
@Test
    public void testFindAmongWithMatchCallback() throws Throwable {
        ...
        var invoked = lookup.findVirtual(SnowballProgramTest.class,
                "exampleCallback", MethodType.methodType(boolean.class, SnowballProgram.class));
...
@Test
    public void testFindAmongWithSubstringFallback() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var methodHandleFalse = lookup.findVirtual(SnowballProgramAdditionalTest.class,
                "falseCallback", MethodType.methodType(boolean.class, SnowballProgram.class));
...
@Test
    public void testFindAmongBThrowsFromMethod() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var throwingMethod = lookup.findVirtual(SnowballProgramEdgeCaseTest.class,
                "throwingCallback", MethodType.methodType(boolean.class, SnowballProgram.class));

        Among[] arr = new Among[]{
                new Among("ing", 0, 1, throwingMethod, "")
        };
...
@Test
    public void testFindAmongReturnsZeroWhenCallbackReturnsFalse() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var method = lookup.findVirtual(SnowballProgramCoverageEnhancementTest.class,
                "falseReturningMethod", MethodType.methodType(boolean.class, SnowballProgram.class));
...
@Test
    public void testFindAmongThrowsUndeclaredThrowableException() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var handler = lookup.findVirtual(SnowballProgramCoverageEnhancementTest.class,
                "throwingMethod", MethodType.methodType(boolean.class, SnowballProgram.class));
...
@Test
    public void testFindAmongPrefixMatchesButCallbackFailsFallbackToSubstringIndex() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var handle = lookup.findVirtual(SnowballProgramEdgeCoverageTest.class,
                "returningFalse", MethodType.methodType(boolean.class, SnowballProgram.class));
...
@Test
    public void testFindAmongInvokesAndThrowsExceptionInWrapper() throws Throwable {
        ...
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        var h = lookup.findVirtual(SnowballProgramEdgeCoverageTest.class,
                "throwingMethod", MethodType.methodType(boolean.class, SnowballProgram.class));
