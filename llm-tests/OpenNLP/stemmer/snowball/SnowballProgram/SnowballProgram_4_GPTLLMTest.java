...
@Test
    public void testFindAmongMatchWithoutMethod() {
        ...
        Among[] among = new Among[] {
            new Among("test", -1, 111, null),
            new Among("testing", -1, 222, null)
        };
...
@Test
    public void testFindAmongBMatchWithoutMethod() {
        ...
        Among[] among = new Among[] {
            new Among("less", -1, 300, null),
            new Among("ing", -1, 301, null)
        };
...
@Test
    public void testFindAmongWithMethodReturnsFalse() throws Throwable {
        ...
        Among[] among = new Among[] {
            new Among("walked", -1, 888,
                MethodHandles.lookup()
                             .findVirtual(MockSnowballProgram.class, "methodFalse", MethodType.methodType(boolean.class))
...
public void testFindAmongBNoMatch() {
    ...
    Among[] items = new Among[] {
        new Among("ingy", -1, 1, null),
        new Among("zzz", -1, 2, null)
    };
...
public void testFindAmongContinuesSearchOnMethodFalse() throws Throwable {
    ...
    Among a1 = new Among("storm", 1, 1,
            java.lang.invoke.MethodHandles.lookup()
                    .findVirtual(SnowballProgram.class, "equals")
                    .asType(java.lang.invoke.MethodType.methodType(boolean.class, SnowballProgram.class))
    );
...
public void testFindAmongReturnsZeroWhenMethodThrows() {
    ...
    Among a = new Among("storming", -1, 1,
            java.lang.invoke.MethodHandles.constant(boolean.class, new Object()) 
            .asType(java.lang.invoke.MethodType.methodType(boolean.class, SnowballProgram.class))
    );
    Among[] v = new Among[]{ a };
...
public void testFindAmongInspectsFirstKeyTwiceWhenNeeded() {
    ...
    Among[] v = new Among[]{
        new Among("alike", -1, 1, null),
        new Among("alien", -1, 2, null)
    };
