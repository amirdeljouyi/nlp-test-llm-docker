...
@Test
    public void testFindAmongReturnsCorrectResultWithMethod() throws Throwable {
        MethodHandle methodHandle = MethodHandles.lookup().findVirtual(
                TestWrapper.class, "mockMethod", MethodType.methodType(boolean.class));
...
@Test
    public void testFindAmongWithMethodReturningFalse() throws Throwable {
        MethodHandle mh = MethodHandles.lookup().findVirtual(
            TestWrapperFailure.class, "methodFalse", MethodType.methodType(boolean.class)
        );
...
@Test
    public void testFindAmongHandlesUndeclaredThrowableException() {
        SnowballProgram program = new SnowballProgram() {};
        MethodHandle mh = MethodHandles.throwException(boolean.class, Exception.class)
            .bindTo(new RuntimeException("test"));
...
@Test
    public void testFindAmongReturnsZeroWhenMatchFailsAfterMethodReturnsFalse() throws Throwable {
        MethodHandle falseHandle = MethodHandles.lookup().findVirtual(
                SnowballProgramFindAmongMock.class, "shouldReturnFalse", MethodType.methodType(boolean.class)
        );
        Among[] variants = new Among[]{
                new Among("run", -1, 1, falseHandle)
        };
...
@Test
    public void testFindAmongBranchingViaSubstringI() throws Throwable {
        MethodHandle mh = MethodHandles.lookup().findVirtual(
            AmongStub.class, "returnFalse", MethodType.methodType(boolean.class)
        );
...
@Test
    public void testFindAmongMethodThrowsCheckedException() throws Exception {
        SnowballProgram program = new SnowballProgram() {};
        MethodHandle throwing = MethodHandles.throwException(boolean.class, Exception.class)
            .bindTo(new Exception("expected"));
...
@Test
    public void testFindAmongBreaksWithFirstKeyAlreadyInspected() {
        SnowballProgram program = new SnowballProgram();
        Among[] variants = new Among[] {
            new Among("ab", 0, 1, null),
            new Among("abc", -1, 2, null)
        };
...
@Test
    public void testFindAmongThrowsUndeclaredIfThrowableIsNotErrorOrRuntime() throws Throwable {
        MethodHandle failing = MethodHandles.throwException(boolean.class, Exception.class)
            .bindTo(new Exception("mocked"));
        Among[] list = new Among[] {
            new Among("abc", -1, 1, failing)
        };
        SnowballProgram program = new SnowballProgram();
        program.setCurrent("abc");
        try {
