...
@Test
    public void testFindAmong_SimpleMatchWithoutMethod() {
        ...
        Among[] among = new Among[] {
            new Among("walk", -1, 1, null),
            new Among("walked", 0, 2, null)
        };
...
@Test
    public void testFindAmong_WithMethodReturnsTrue() throws Throwable {
        ...
        Among[] among = new Among[] {
            new Among("marked", -1, 5,
                MethodHandles.lookup().findVirtual(program.getClass(), "acceptMatch", MethodType.methodType(boolean.class)))
        };
        int result = program.find_among(among);
...
@Test
    public void testFindAmong_WithMethodReturnsFalse() throws Throwable {
        ...
        Among[] among = new Among[] {
            new Among("failed", -1, 3,
                MethodHandles.lookup().findVirtual(program.getClass(), "rejectMatch", MethodType.methodType(boolean.class)))
        };
        int result = program.find_among(among);
...
@Test
    public void testFindAmong_PartialPrefixMatchReturnsLowerResult() {
        ...
        Among[] candidates = new Among[] {
            new Among("in", -1, 1, null),
            new Among("interaction", 0, 2, null)
        };
...
@Test
    public void testFindAmong_MethodThrowsException() throws Throwable {
        ...
        Among[] important = new Among[] {
            new Among("boom", -1, 1,
                MethodHandles.lookup().findVirtual(program.getClass(), "faulty", MethodType.methodType(boolean.class)))
        };
        try {
...
@Test
    public void testFindAmong_TwoKeys_FirstFailsSecondMatches() {
        ...
        Among[] v = new Among[] {
            new Among("speed", -1, 1, null),
            new Among("speech", -1, 2, null)
        };
        int result = program.find_among(v);
        assertEquals(2, result);
    }
...
@Test
    public void testFindAmongB_SubstringIndexFallbackToZero() {
        ...
        program.cursor = 9;
        Among[] v = new Among[] {
            new Among("ed", 1, 1, null),
            new Among("relearned", -1, 5, null)
        };
        int result = program.find_among_b(v);
        assertEquals(5, result);
    }
@Test
    public void testFindAmong_MethodThrowsUncheckedException() throws Throwable {
        ...
        Among[] list = new Among[] {
            new Among("test", -1, 1,
                MethodHandles.lookup().findVirtual(program.getClass(), "bad", MethodType.methodType(boolean.class)))
        };
...
@Test
    public void testFindAmong_MethodReturnsFalse_ShouldFallThrough() throws Throwable {
        ...
        Among[] list = new Among[] {
            new Among("ending", -1, 9,
                MethodHandles.lookup().findVirtual(program.getClass(), "condition", MethodType.methodType(boolean.class)))
        };
...
@Test
    public void testFindAmong_DifferentLengthPrefixFails() {
        ...
        Among[] values = new Among[] {
            new Among("enjoyed", -1, 1, null),
            new Among("enjoying", -1, 2, null)
        };
...
@Test
    public void testFindAmong_MultipleMatches_PicksLongest() {
        ...
        Among[] values = new Among[] {
            new Among("pre", -1, 1, null),
            new Among("precom", -1, 2, null),
            new Among("precomputed", -1, 3, null)
        };
        int result = program.find_among(values);
...
@Test
    public void testFindAmongB_SingleMatchReturnsCorrectResult() {
        ...
        Among[] values = new Among[] {
            new Among("ed", -1, 1, null),
            new Among("ned", 0, 2, null),
            new Among("igned", 1, 3, null)
        };
        int result = program.find_among_b(values);
        assertEquals(3, result);
    }
...
@Test
    public void testFindAmong_NoCommonPrefix_ShouldReturnZero() {
        ...
        Among[] array = new Among[] {
            new Among("world", -1, 1, null)
        };
...
@Test
    public void testFindAmong_MiddleItemMatch() {
        ...
        program.setCurrent("testing");
        Among[] array = new Among[] {
            new Among("test", -1, 1, null),
            new Among("testing", -1, 2, null),
            new Among("tester", -1, 3, null)
        };
        int result = program.find_among(array);
        assertEquals(2, result);
    }
...
@Test
    public void testFindAmong_MatchWhenMethodReturnsTrue() throws Throwable {
        SnowballProgram program = new SnowballProgram() {
            public boolean dynamicMatch() { return true; }
        };
        program.setCurrent("invoke");

        Among[] values = new Among[] {
            new Among("invoke", -1, 7,
                MethodHandles.lookup().findVirtual(program.getClass(), "dynamicMatch", MethodType.methodType(boolean.class)))
        };
...
@Test
    public void testFindAmong_MatchWhenMethodReturnsFalse_ShouldReturnZero() throws Throwable {
        SnowballProgram program = new SnowballProgram() {
            public boolean dynamicReject() { return false; }
        };
        program.setCurrent("logic");

        Among[] values = new Among[] {
            new Among("logic", -1, 5,
                MethodHandles.lookup().findVirtual(program.getClass(), "dynamicReject", MethodType.methodType(boolean.class)))
        };
...
@Test
    public void testFindAmong_MethodThrowsThrowable_ShouldWrapAndThrow() throws Throwable {
        ...
        Among[] values = new Among[] {
            new Among("crash", -1, 1,
                MethodHandles.lookup().findVirtual(program.getClass(), "throwsChecked", MethodType.methodType(boolean.class)))
        };
...
@Test
    ...
    public void testFindAmong_MatchesOnFirstTry() {
        ...
        program.setCurrent("abc");
        Among[] v = new Among[] {
            new Among("abc", -1, 42, null),
            new Among("abcd", 0, 9, null)
        };
        int result = program.find_among(v);
    ...
    public void testFindAmong_SamePrefixDifferentLengths_SelectsLongest() {
        ...
        Among[] list = new Among[] {
            new Among("prefix", -1, 1, null),
            new Among("prefixlong", -1, 2, null),
            new Among("prefixlongest", -1, 3, null)
        };
        int result = program.find_among(list);
        assertEquals(3, result);
    }
    ...
    public void testFindAmongB_ShouldReturnResultFromMethodTrue() throws Throwable {
        ...
        Among[] arr = new Among[] {
            new Among("abc", -1, 7,
                MethodHandles.lookup().findVirtual(program.getClass(), "accept", MethodType.methodType(boolean.class)))
        };
