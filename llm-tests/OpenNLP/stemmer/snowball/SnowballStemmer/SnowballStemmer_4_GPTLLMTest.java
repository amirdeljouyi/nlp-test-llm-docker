...
@Test
  public void testIllegalStateThrownForUnknownAlgorithmViaReflection() throws Exception {
    ...
    SnowballStemmer.ALGORITHM invalidAlgorithm = (SnowballStemmer.ALGORITHM) Enum.valueOf(
        (Class<Enum>) Class.forName("opennlp.tools.stemmer.snowball.SnowballStemmer$ALGORITHM"),
        "ARABIC"); 
