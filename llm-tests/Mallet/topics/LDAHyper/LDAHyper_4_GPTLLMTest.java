...
InstanceList instances = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\p{L}+")), new TokenSequence2FeatureSequence())));
...
InstanceList emptyList = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\p{L}+")), new TokenSequence2FeatureSequence())));
LDAHyper lda = new LDAHyper(3);
...
InstanceList list = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\S+")), new TokenSequence2FeatureSequence())));
...
InstanceList training = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\w+")), new TokenSequence2FeatureSequence())));
training.addThruPipe(new Instance("apple banana", null, "train", null));
InstanceList testing = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\w+")), new TokenSequence2FeatureSequence())));
...
InstanceList training = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\S+")), new TokenSequence2FeatureSequence())));
...
InstanceList list = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\w+")), new TokenSequence2FeatureSequence())));
...
LDAHyper lda = new LDAHyper(2);
lda.addInstances(new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\p{L}+")), new TokenSequence2FeatureSequence()))));
...
InstanceList training = new InstanceList(new SerialPipes(Arrays.asList(new CharSequence2TokenSequence(Pattern.compile("\\p{L}+")), new TokenSequence2FeatureSequence())));
